    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <motion.div
                ...
                className="w-full max-w-5xl bg-card rounded-[20px] shadow-card overflow-hidden flex flex-col md:flex-row"
            >
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <h2 className="text-2xl font-bold text-foreground mb-8">Administrator Login</h2>
                ...
                <div className="hidden md:flex md:w-1/2 bg-background p-12 items-center justify-center relative overflow-hidden border-l border-border">
