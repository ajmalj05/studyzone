...
export function MonthlyPayrollTab() {
      ...
      <Dialog open={!!markPaidPayment} onOpenChange={(open) => !open && setMarkPaidPayment(null)}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              {markPaidPayment &&
                `${markPaidPayment.teacherName} - ${payrollMonthName(markPaidPayment.month)} ${markPaidPayment.year}. Net: ${formatPayrollCurrency(markPaidPayment.netAmount)}`}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={!!lineModalPayment} onOpenChange={(open) => !open && setLineModalPayment(null)}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              {lineModalPayment?.teacherName} - {lineModalPayment && payrollMonthName(lineModalPayment.month)} {lineModalPayment?.year}
            </DialogDescription>
          </DialogHeader>
