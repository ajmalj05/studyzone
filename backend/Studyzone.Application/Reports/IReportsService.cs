...
public interface IReportsService
{
    ...
    Task<FinancialReportDto> GetFinancialReportAsync(DateTime? from, DateTime? to, CancellationToken ct = default);
    Task<AttendanceReportDto> GetAttendanceReportAsync(string? classId, DateTime from, DateTime to, CancellationToken ct = default);
