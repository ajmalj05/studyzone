...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, string connectionString, IConfiguration? configuration = null)
    {
        ...
        services.AddScoped<IStaffSalaryPaymentRepository, StaffSalaryPaymentRepository>();
        services.AddScoped<IStaffSalaryPaymentLineRepository, StaffSalaryPaymentLineRepository>();
        services.AddScoped<IStaffSalaryPaymentService, StaffSalaryPaymentService>();
